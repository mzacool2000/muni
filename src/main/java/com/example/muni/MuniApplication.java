    ...
    @Jonh{
        ...
        Depósito Central{
            Ingreso Medicamentos:,
                Usar numero certificado 
                
            Transferir Medicamentos: (A centros de Salud),
            Transferir Medicamentos: (Entre Centros de Salud),
            Control de Stock: {
                cantidad Medicamentos: (notificacion: control de 
                                     Stock minimo para realizar pedido),
                vencimiento Medicamentos: (notificacion: control de fecha de Caducidad)
            }
        }
        Despósito Centro Salud{
            Egreso Medicamentos: {
                baja en stock:,
                registro de persona:,
            }
            Control de Stock: {
                cantidad Medicamentos: (notificacion: control de stock minimo para realizar pedido),
                vencimiento medicamentos: (notificacion: control de fecha de caducidad), 
            }
        }
